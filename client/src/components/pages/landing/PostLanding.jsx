    ...
    return (
      <div className="post-landing-page">
        ...
        <div className="post-landing-searchbar-wrapper">
          <form className="post-landing-searchbar">
            <span className="fas fa-search"></span>
            <input className="post-landing-search" />
          </form>
        ...
        <div className="post-landing-video-pull">
          ...
          <div className="individual-video-space">
            ...
            <h3>Video Title</h3>
            <p className="video-description">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam scelerisque ante eros, eu gravida leo viverra quis. Nulla justo purus, tempor vel sapien ...</p>
          </div>
